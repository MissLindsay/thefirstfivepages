     ...
     <?php include ('header.php'); ?>
  	 <div class="container">
        ...
        <div id="accountBasics">
		    <div class="userHandle">Kalimeris(change email/password)</div>
			<div class="tokenStatus">250 tokens remaining(request tokens)</div>
		
      </div>
	  </div>
  	   <div class="titleBars">Purchased</div>
       <?php include('purchased.php'); ?>

	   <div class="titleBars">Previews</div>
